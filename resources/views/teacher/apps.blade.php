...
<body>
    <div class="sidebar sidebar-fixed" style="background: #4f2cd9 !important;" id="sidebar">
        <ul class="sidebar-nav" data-coreui="navigation" data-simplebar="">
            ...
            <li class="nav-title fs-5 mt-0">
                ...
                Hello, {{ Auth::user()->teacher->first_name }} {{ Auth::user()->teacher->middle_name }}
                {{ Auth::user()->teacher->last_name }}
            </li>
    ...
    <div class="wrapper d-flex flex-column min-vh-100 bg-light">
        ...
        <div class="flex-grow-1 px-3 mb-5">
            ...
            @endif
            @if (Session::has('success_module'))
                <script>
                    document.addEventListener('DOMContentLoaded', function () {
                        // Show SweetAlert success notification
                        Swal.fire({
                            title: 'Success!',
                            text: "{{ Session::get('success_module') }}",
                            icon: 'success',
                            confirmButtonText: 'OK'
                        });

                        let moduleId = "{{ Session::get('module_id') }}";
                        if (moduleId) {
                            let modal = document.getElementById(`exampleModalView-${moduleId}`);
                            if (modal) {
