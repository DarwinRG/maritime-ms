                            ...
                            <td class="d-flex align-items-center" style="gap: 5px;">
                                <div>
                                    ...
                                    <div class="modal fade" id="exampleModal-{{ $program->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <form action="{{ route('admin.course.update',$program->id) }}" method="POST">
                                            @csrf
                                            @method('PUT')
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="">Course Code</label>
                                                            <input type="text" class="form-control" value="{{ $program->code }}" name="code">
                                                        </div>
                                                    </div>
                                                    <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                 ...
                                 <div>
                                    <form action="{{ route('admin.course.destroy', $program->id) }}" method="POST" class="delete-form">
                                        @csrf
                                        @method('DELETE')
