                            ...
                            <td class="d-flex align-items-center" style="gap: 5px;">
                                <div>
                                    ...
                                    <div class="modal fade" id="exampleModal-{{ $program->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <form action="{{ route('admin.subject.update',$program->id) }}" method="POST">
                                            @csrf
                                            @method('PUT')
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select name="course_id" id="course_id" class="form-control">
                                                                @foreach ($courses as $course)
                                                                    <option value="{{ $course->id }}" @selected(old('course_id', $program->course_id ?? '') == $course->id)>
                                                                        {{ $course->name }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                 ...
                                 <div>
                                    <form action="{{ route('admin.subject.destroy', $program->id) }}" method="POST" class="delete-form">
                                        @csrf
                                        @method('DELETE')
