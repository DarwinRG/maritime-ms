    ...
    <ul class="sidebar-nav" data-coreui="navigation" data-simplebar="">
        <li class="nav-title fs-5 mt-0 d-flex flex-column align-items-center gap-2">
            ...
            <div class="text-center">
                <div>
                  <span class="fs-5" style="font-size: 0.7rem !important;">  <span style="font-size: 1rem !important;">Hello</span>, {{ Auth::user()->student->first_name }} {{ Auth::user()->student->middle_name }} {{ Auth::user()->student->last_name }}</span>
                </div>
                <div class="fs-6">
        ...
        <li class="nav-item w-100">
            <a class="nav-link {{ Route::is('student.setting.*') || Route::is('student.setting.*') ? 'active' : '' }}" href="{{ route('student.setting.index') }}">
                <span class="flex gap-x-3 items-center">
